...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Usuarios (Administrador)</div>
                ...
                @if (auth()->user()->role ==0)
                    ...
                    <div class="card-body">
                        ...
                        @endif
                         ...
                         {!! Form::open(['url'=>'/usuarios', 'method' =>'GET', 'class'=>'navbar navbar-light bg-light pull-right form-inline' ,'role'=>'search']) !!}
                    {!! Form::text('names',null, ['class'=>'form-control mr-xl-2', 'placeholder'=> 'Buscar por nombre']) !!}
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center">
                       ...
                       <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#edit">Crear Usuario
                           ...
                           <tbody>
                            @foreach($users as $User)
                               <tr>
                                   ...
                                   <a href="/editUser/{{$User->id}}" class="btn btn-sm btn-success" title="Editar">Editar</a>
                                   </td>-->
